...
#include "struct/readdata.h"
#include "struct/imgbuffer.h"
...
//    std::thread     thd_soft_trigger;       //获取算法结果线程
    ...
    TIME_TYPE time_trigger_start, time_buffer_start, time_buffer_end;
    TIME_TYPE time_analyse_start, time_qimg_start, time_qimg_end;

    QList<long>  timeList_trigger_start;
    QList<long>  timeList_buffer_start;
    QList<long>  timeList_buffer_end;
    QList<long>  timeList_analyse_start;
    QList<long>  timeList_qimg_start;
    QList<long>  timeList_qimg_end;
