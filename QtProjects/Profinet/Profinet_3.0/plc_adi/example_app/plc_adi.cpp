...
void PLC_Adi::thd_actionFunction()
{
    ...
    for(;;)
    {
        ...
        //切换状态--运动完成
        case State_Rough_Detect:
        case State_Fine_Detect:
        {
            judgeMoveOverState();
            break;
        }
        ...
        //切换状态--请求复检
        case State_Fine_MoveOver:
        {
            if( compareRegisterValue( REG_ID_Read_ReDetect, 1 ) )
            {
