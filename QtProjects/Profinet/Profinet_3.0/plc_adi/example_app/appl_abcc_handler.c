...
BOOL ABCC_CbfUpdateWriteProcessData( void* pxWritePd )
{
    ...
    */
    ...
    //心跳
//    if( *(APPL_asAdiEntryList[5].uData.sUINT32.plValuePtr) == heartBeat_Read )
//    *(APPL_asAdiEntryList[6].uData.sUINT32.plValuePtr) = 100;
//    *(APPL_asAdiEntryList[7].uData.sUINT32.plValuePtr) = 100;
...
//    printf( "\n WriteValue: 0x0A, 0x0B:%d\n", *(APPL_asAdiEntryList[4].uData.sUINT32.plValuePtr));

//    for( int i = 0; i < 4; i++ )
//    {
//        readValue[i] = *(APPL_asAdiEntryList[i].uData.sUINT16.piValuePtr);
//    }
}
