...
**------------------------------------------------------------------------------
** Arguments:
**   fSelectDlg - show an select dialog
**   pszHardwareSerial - if fSelectDlg is FALSE this variable defines the hardware to
**                       initialize
** Returns:
**    ABCC_ErrorCodeType
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_HwInit( BOOL fSelectDlg, char * pszHardwareSerial );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_HwRelease( void );
...
**------------------------------------------------------------------------------
*/
EXTFUNC ABCC_ErrorCodeType ABCC_ReturnMsgBuffer( ABP_MsgType * psMsg );
...
/*------------------------------------------------------------------------------
** This function set the Read Process Data and Write Process Data size
**------------------------------------------------------------------------------
** Arguments:
**    none
**
