...
#define REG_ID_SUB_HEART_BEAT_R 5   //读心跳寄存器(Read)
#define REG_ID_SUB_MOVE_OVER    3   //运动结束寄存器(Read)
#define REG_ID_SUB_REDETECT     4   //复检寄存器(Read)
//#define REG_ID_SUB_CLEAR_DATA   5 //清零寄存器(Read)

#define REG_ID_SUB_IN_PLACE         6   //就位寄存器(Write)
#define REG_ID_SUB_POS_W_X          7   //结果x坐标寄存器(Write)
#define REG_ID_SUB_POS_W_Y          8   //结果y坐标寄存器(Write)
#define REG_ID_SUB_DET_RESULT_OK    9   //检测结果OK寄存器(Write)
#define REG_ID_SUB_DET_RESULT_NG    10  //检测结果NG寄存器(Write)
#define REG_ID_SUB_REDET_RESULT     10  //复检结果寄存器(Write)
#define REG_ID_SUB_HEART_BEAT_W     12  //写心跳寄存器(Write)
