...
int main(int argc, char *argv[])
{
    ...
    QObject::connect( &ui,  SIGNAL( sendResultPosition(bool,int,int) ),
                      &plc, SLOT( rcvResultPosition(bool,int,int) ) );

    QObject::connect( &ui,  SIGNAL( sendReDetectResult(bool)),
                      &plc, SLOT( rcvReDetectResult(bool) ) );

    QObject::connect( &ui,  SIGNAL( sendJudgeResult(bool) ),
                      &plc, SLOT( rcvJudgeResult(bool) ) );
